...
import project.kavyasrees3537153.packagetracker.ui.theme.PackageTrackerTheme
...
fun AppNavGraph() {
    ...
    NavHost(
        ...
        composable(AppRoutes.Notifications.route) {
            PackageDeliveryNotificationsScreen(navController)
        }
        ...
        composable(AppRoutes.AboutUs.route)
        {
...
fun PackageTrackerStartScreen(navController: NavController) {
    ...
    LaunchedEffect(Unit) {
        ...
        if (TrackingAccountData.checkLoginStatus(context)) {
